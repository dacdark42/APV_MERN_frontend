...
const Paciente = ({paciente}) => {
    ...
    const formatearFecha = (fecha) =>{
        ...
        return new Intl.DateTimeFormat('es-CH', {dateStyle: 'long'}).format(nuevaFecha)
    }
    ...
    <div className="mx-5 my-10 bg-white shadow-md px-5 p-10 rounded-xl ">
        ...
        <div className="flex justify-between my-5">
            ...
            >Editar</button>
            <button type="button" className="py-2 px-10 bg-red-600 hover:bg-indigo-700 text-white uppercase font-bold rounded-lg"
